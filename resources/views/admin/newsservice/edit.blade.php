                  ...
                  <div class="x_title">
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="id_service">
                          <option value="">Chọn dịch vụ</option>
                          @foreach($service as $item)
                            <option @if($item['id']==$value_frm['id']) selected="true" @endif value="{{$item['id']}}">{{$item['name']}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255" value="{{ $value_frm['name'] }}">
                        @if ($errors->Has ('name'))
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <textarea id="textarea" required="required" name="content" class="form-control col-md-7 col-xs-12">{{ $value_frm['content'] }}</textarea>
                        <script>
