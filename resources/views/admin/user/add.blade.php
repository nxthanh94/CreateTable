                  ...
                  <div class="x_title">
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="name" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255" value="{!! old('name') !!}">
                        @if ($errors->Has ('name'))
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="username" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255" value="{!! old('username') !!}">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="password" type="password" name="password" data-validate-length="6,8" class="form-control col-md-7 col-xs-12" required="required" maxlength="100">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="password2" type="password" name="password2" data-validate-linked="password" class="form-control col-md-7 col-xs-12" required="required" maxlength="100">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="email" placeholder="Vui lòng nhập thông tin" required="required" type="email" maxlength="255" value="{!! old('email') !!}">
                        @if ($errors->Has ('email'))
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input type="tel" id="telephone" name="phone" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Vui lòng nhập thông tin" maxlength="20" value="{!! old('phone') !!}">
                        @if ($errors->Has ('phone'))
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="diachi" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255" value="{!! old('diachi') !!}">
