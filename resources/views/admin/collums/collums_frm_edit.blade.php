                  ...
                  <div class="x_title">
                    <div class="item-cot">
                              <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12">Tên cột</label>
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                  <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="name" placeholder="Vui lòng nhập tên cột" required="required" type="text" maxlength="255" value="{{$value_frm['name']}}">
                                </div>
                              </div>
                              <div class="item form-group">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                  <select id="heard" class="form-control" required name="type">
                                      @foreach( $type as $key=>$item)
                                        <option @if($key == $value_frm['type'])  selected="true" @endif value="{{$key}}">{{$item}}</option>
                                      @endforeach
                                  </select>
                                </div>
