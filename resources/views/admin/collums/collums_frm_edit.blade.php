                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate
                                  action="{{ route($action,$value_frm['id']) }}" method="post"
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <input id="name" class="form-control col-md-7 col-xs-12"
                                                               ...
                                                               placeholder="Vui lòng nhập tên cột" required="required"
                                                               type="text" maxlength="255"
                                                               value="{{$value_frm['name']}}">
                                                    </div>
                                                </div>
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <select id="heard" class="form-control" required name="type">
                                                            @foreach( $type as $key=>$item)
                                                                <option @if($key == $value_frm['type'])  selected="true"
