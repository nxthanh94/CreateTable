 <div class="navbar-default sidebar col-lg-3" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html">CHỌN DỊCH VỤ ĐANG ÁP DỤNG</a>
                        </li>
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Bảng</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Quỳ trình</a>
                        </li>
                        <li>
