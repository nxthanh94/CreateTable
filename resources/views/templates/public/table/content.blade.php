<!-- Modal -->
<div class="modal fade" id="qrcode_png" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-primary filter-table"><i class="fa fa-filter" aria-hidden="true"></i></a>
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td colspan="{{count($collums)}}">
                    ...
                    <a href="{{route('table.viewtable',['slug'=>$slug_table,'id'=>$id_table])}}" data="{{$id_table}}"
                       class="btn btn-info">Xem bảng</a>
                    <a href="{{route('table.exportexcel',['slug'=>$slug_table,'id'=>$id_table])}}" data="{{$id_table}}"
                       class="btn btn-info">Export</a>
                    <a href="{{route('table.exportpdf',['slug'=>$slug_table,'id'=>$id_table])}}" data="{{$id_table}}"
                       class="btn btn-info">Exprot pdf</a>
